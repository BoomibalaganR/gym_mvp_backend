...
exports.lastNMonthsMemberSchema = exports.feeDateRangeSchema = exports.markPendingFeeSchema = exports.verifyFeeSchema = exports.createFeeSchema = void 0;
const joi_1 = __importDefault(require("joi"));
const monthRegex = /^\d{4}-(0[1-9]|1[0-2])$/;
exports.createFeeSchema = {
    body: joi_1.default.object({
        months: joi_1.default.array()
        ...
        paymentType: joi_1.default.string().valid("cash", "gpay").required().messages({
...
exports.verifyFeeSchema = {
    body: joi_1.default.object({
        feeIds: joi_1.default.array()
            .items(joi_1.default.string()
            .trim()
            .length(24)
            .hex()
...
exports.markPendingFeeSchema = {
    body: joi_1.default.object({
        feeId: joi_1.default.string()
            .trim()
            .length(24)
            .hex()
            .messages({
...
exports.feeDateRangeSchema = {
    query: joi_1.default.object({
        ...
        verifiedByOwner: joi_1.default.boolean()
            .truthy('true')
            .falsy('false')
            .optional()
            .messages({
...
exports.lastNMonthsMemberSchema = {
    query: joi_1.default.object({
        month: joi_1.default.string(),
        monthsCount: joi_1.default.number().integer().min(0).optional(),
        status: joi_1.default.string().valid('paid', 'unpaid', 'pending').optional(),
        continuousUnpaid: joi_1.default.boolean().optional()
    }).options({ stripUnknown: true, abortEarly: true })
};
